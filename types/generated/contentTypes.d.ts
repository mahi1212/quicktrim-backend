...
export interface ApiAppointmentAppointment extends Schema.CollectionType {
  ...
  attributes: {
    user_id: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    shop_id: Attribute.Relation<
      'api::appointment.appointment',
      'oneToOne',
      'api::shop.shop'
    >;
    appointment_name: Attribute.Text & Attribute.Required;
    phone: Attribute.Text;
    date: Attribute.Date;
    time: Attribute.Time & Attribute.Required;
    appointment_status: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPackagePackage extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.Text & Attribute.Required;
    price: Attribute.Text & Attribute.Required;
    time: Attribute.Text & Attribute.Required;
    image: Attribute.Media;
    shop: Attribute.Relation<
      'api::package.package',
      'oneToOne',
...
export interface ApiShopShop extends Schema.CollectionType {
  ...
  attributes: {
    ...
    waiting: Attribute.Text;
    avgTime: Attribute.Text;
